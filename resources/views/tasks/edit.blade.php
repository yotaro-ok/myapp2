    ...
    <div class="col-md-8">
        <form action="{{ route('tasks.update', $task->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="subject" id="subject-field" value="{{ old('subject', $task->subject ) }}" />
            </div>
            <div class="form-group">
                <label for="description-field">Description</label>
                <textarea name="description" id="description-field" class="form-control" rows="3">{{ old('description', $task->description ) }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group form-check">
                <input class="form-check-input" type="checkbox" name="completed" id="completed-field" value="1" @if( $task->completed ) checked @endif/>
